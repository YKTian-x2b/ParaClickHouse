...
/** Which blocks by default read the data (by number of rows).
  ...
  */
  // kai mod [65409, 261636, 1046544, 4186176] [65536, 1048576, 16777216]
#define DEFAULT_BLOCK_SIZE 1048576 /// 65536 - PADDING_FOR_SIMD - (PADDING_FOR_SIMD - 1) bytes padding that we usually have in arrays
